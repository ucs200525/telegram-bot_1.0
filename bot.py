...
# Function to convert Excel to image using excel2img
def save_excel_range_as_image(excel_file_path, output_image_path, sheet_name, cell_range):
    try:
        if sheet_name and cell_range:
            excel2img.export_img(excel_file_path, output_image_path, sheet_name, cell_range)
...
async def receive_location(update: Update, context: CallbackContext):
    ...
    if result and len(result):
        ...
        save_excel_range_as_image(file_path, save_image_path, "Sheet1", "B1:L32")
...
def main():
    ...
    excel_file_path = r'C:\Users\sree\Desktop\Completed_eng_Bharghava_Siddhanta_Panchangam.xlsx'
    image_save_path = r'C:\Users\sree\Desktop\ExcelToImage.png'
